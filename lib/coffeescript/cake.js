...
(function() {
  ...
  cakefileDirectory = function(dir) {
    var cakefiles, parent;
    cakefiles = ['Cakefile', 'cakefile', 'cakefile.coffee', 'Cakefile.coffee'];
    if (cakefiles.some(function(cakefile_name) {
      return fs.existsSync(path.join(dir, cakefile_name));
    })) {
      return dir;
    }
    ...
    throw new Error(`Cakefile not found in ${process.cwd()} (looking for: ${cakefiles.join(', ')})`);
  };
